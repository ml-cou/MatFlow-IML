...
def customplot(df, data):
    ...
    for x in xs:
            ...
            for label in hue_categories:
                ...
                fig_line.add_trace(
                    go.Scatter(
                        ...
                        mode='lines',
                        name=f"{x} {label}",
                        line=dict(color=hue_color_mapping[label], width=2.5)
                    )
                )
        else:
            fig_line = go.Figure(
                data=[
                    go.Scatter(
                        ...
                        mode='lines',
                        name=x,
                        line=dict(color='rgba(0, 0, 255, 1)', width=2.5)  # Blue color
                    )
                ]
            )
        ...
        fig_line.update_layout(
            title=data.get('title', f"Line Plot of {y} vs {x}"),
            xaxis_title=x,
            yaxis_title=y,
            showlegend=True,
            height=600,
            ...
            for label in hue_categories:
                ...
                fig_scatter.add_trace(
                    go.Scatter(
                        ...
                        mode='markers',
                        name=f"{x} {label}",
                        marker=dict(color=hue_color_mapping[label], size=8)
                    )
                )
        else:
            fig_scatter = go.Figure(
                data=[
                    go.Scatter(
                        ...
                        mode='markers',
                        name=x,
                        marker=dict(color='rgba(0, 0, 255, 1)', size=8)  # Blue color
                    )
                ]
            )
        ...
        fig_scatter.update_layout(
            title=data.get('title', f"Scatter Plot of {y} vs {x}"),
            xaxis_title=x,
            yaxis_title=y,
            showlegend=True,
            height=600,
